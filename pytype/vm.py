...
class VirtualMachine:
  ...
  def binary_operator(self, state, name, report_errors=True):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": line, "offset": offset, "opcode": "BINARY_OP",
                        "name": name,
  ...
  def call_function_with_state(
    ...
    if funcv.data[0].name == 'append':
      if self.frame.f_code is not None:
        opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": line, "offset": offset, "opcode": "APPEND", "funcv": funcv,
                            "posargs": posargs, "namedargs": namedargs, "starargs": starargs,
                            "starstarargs": starstarargs, "ret": ret})
      else:
        opcode_list.append({"filename": self.filename, "line": line, "offset": offset, "opcode": "APPEND", "funcv": funcv, "posargs": posargs, "namedargs": namedargs,
                            "starargs": starargs, "starstarargs": starstarargs, "ret": ret})
    elif len(funcv.data) != 1 or funcv.data[0].name != '__setitem__':
      if self.frame.f_code is not None:
        opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": line, "offset": offset, "opcode": "CALL", "funcv": funcv,
                            "posargs": posargs, "namedargs": namedargs, "starargs": starargs, "starstarargs": starstarargs,
                            "ret": ret})
      else:
        opcode_list.append({"filename": self.filename, "line": line, "offset": offset, "opcode": "CALL", "funcv": funcv, "posargs": posargs,"namedargs": namedargs,
                            "starargs": starargs, "starstarargs": starstarargs, "ret": ret})
  ...
  def byte_LOAD_FOLDED_CONST(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "LOAD_FOLDED_CONST",
  ...
  def _load_fast(
    ...
    vm_utils.check_for_deleted(state, name, val, self.ctx)
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "LOAD_FAST",
                        "value_id": f"v{val.id}", "value_data": val.data, "name": name})
    self.trace_opcode(op, name, val)
    return state.push(val)
  ...
  def byte_LOAD_CLOSURE(self, state, op):
    ...
    return vm_utils.load_closure_cell(self.frame.f_code.qualname, state, op, False, self.ctx)

  def byte_LOAD_DEREF(self, state, op):
    """Retrieves a value out of a cell."""
    return vm_utils.load_closure_cell(self.frame.f_code.qualname, state, op, True, self.ctx)
  ...
  def _compare_op(self, state, op_arg, op):
    ...
    if match_enum is not None:
      ...
      opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "COMPARE_OP",
  ...
  def byte_LOAD_ATTR(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "LOAD_ATTR", "name": name,
  ...
  def byte_STORE_ATTR(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "STORE_ATTR", "name": name,
  ...
  def store_subscr(self, state, obj, key, val):
    ...
    line, offset = (find_op_in_callers().line, find_op_in_callers().col) if find_op_in_callers() is not None else (-1, -1)
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": line, "offset": offset, "opcode": "STORE_SUBSCR",
  ...
  def byte_BUILD_TUPLE(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "BUILD_TUPLE",
  ...
  def _unpack_sequence(self, state, n_before, n_after=-1):
    ...
    for value in reversed(values):
      ...
      state = state.push(value)
    line, offset = (find_op_in_callers().line, find_op_in_callers().col) if find_op_in_callers() is not None else (-1, -1)
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, 'line': line, 'offset': offset, 'opcode': 'UNPACK_SEQUENCE',
  ...
  def byte_BUILD_SLICE(self, state, op):
    if op.arg == 2:
      ...
      opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, 'opcode': 'BUILD_SLICE',
  ...
  def byte_LIST_EXTEND(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "LIST_EXTEND",
  ...
  def byte_MAP_ADD(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "MAP_ADD",
  ...
  def byte_DICT_UPDATE(self, state, op):
    ...
    state, update = state.pop()
    target = state.peek(op.arg)
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "DICT_MERGE",
                        "update_id": f"v{update.id}", "update_data": update.data,
                        "target_id": f"v{target.id}", "target_data": target.data})
  ...
  def byte_GET_ITER(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, 'opcode': 'GET_ITER',
  ...
  def byte_FOR_ITER(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, 'opcode': 'FOR_ITER',
  ...
  def byte_MAKE_FUNCTION(self, state, op):
    ...
    params = func_var.bindings[0].data.get_parameters()
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, 'opcode': 'MAKE_FUNCTION',
                        'func_name': func.name, 'func_var': func_var, 'annot': raw_annot, 'params': params})
  ...
  def byte_YIELD_VALUE(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, 'opcode': 'YIELD_VALUE',
  ...
  def byte_RETURN_VALUE(self, state, op):
    state, var = state.pop()
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, 'opcode': 'RETURN_VALUE',
  ...
  def byte_BUILD_STRING(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "BUILD_STRING",
  ...
  def byte_LOAD_METHOD(self, state, op):
    ...
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "LOAD_METHOD", "name": name, "obj_id": f"v{self_obj.id}", "obj_data": self_obj.data,
  ...
  def byte_RESUME(self, state, op):
    # No stack or type effects
    opcode_list.append({"filename": self.filename, "fullname": self.frame.f_code.qualname, "line": op.line, "offset": op.col, "opcode": "RESUME", 'state_node_name': state.node.name})
    del op
    return state
